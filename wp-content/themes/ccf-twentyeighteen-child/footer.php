        ...
        <div class="wide py-5">
            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-lg-4 mb-4 mb-lg-0 mx-auto text-white">
                    ...
                    <p class="fs-md">CCF is an international non-profit organization headquartered in Namibia, with
                        ...
                        <div class="col-xxl">
                            ...
                            <div class="row matrix-border">
                                ...
                                <div class="col-sm-6 col-lg-12 d-none">
                                    <a class="btn btn-block btn-primary" href="#" title="Sponsor a Cheetah">Sponsor a
                                        Cheetah</a>
                                </div>
                                <!-- .col -->
        ...
        <div class="wide px-lg-2 py-6">
            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-lg-6 col-xl-3 mx-auto">
                    ...
                    <a class="btn btn-block btn-primary" href="#" title="Donate">Donate to CCF Canada</a>
                </div>
                <!-- .col -->
